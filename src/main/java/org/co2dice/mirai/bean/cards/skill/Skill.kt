...
abstract class Skill(){
    ...
    //输入的传参,用来自定义一些卡的效果，比如给殴打输入，就是定义殴打的伤害。给治疗输入，就是定义治疗的回复量。
    ...
    abstract var effect:Function3<Battle,CharacterCard,CharacterCard,Boolean>
    //造成的特效，返回true则技能生效，返回false则技能失效
    abstract var reactEffect:Function3<Battle,CharacterCard,CharacterCard,Boolean>
    //反抗成功后的特效
}