 ...
 **/
class ReleaseEffectInstance (
    entries : List<EffectEntry<ReleaseEffect>>
) : EffectInstance<ReleaseEffect>(entries) {

    constructor(entry : CardEntry<*>) : this(
        entries = entry.effectEntry.filterIsInstance<EffectEntry<ReleaseEffect>>()
    )
