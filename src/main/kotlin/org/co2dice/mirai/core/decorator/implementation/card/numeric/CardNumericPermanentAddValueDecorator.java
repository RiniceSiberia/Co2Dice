 ...
 * @author lcy0x1
 */
public final class CardNumericPermanentAddValueDecorator extends CardPermanentDecorator<
	...
	public CardNumericPermanentAddValueDecorator(CardNumericType type, int value) {
		this.type = type;
		this.value = value;
	}
