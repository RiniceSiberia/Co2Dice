 ...
 * @author DUELIST
 */
public final class CardNumericPermanentDivideValueDecorator extends CardPermanentDecorator<
	...
	public CardNumericPermanentDivideValueDecorator(CardNumericType type, int value) {
		this.type = type;
		this.value = value;
	}
