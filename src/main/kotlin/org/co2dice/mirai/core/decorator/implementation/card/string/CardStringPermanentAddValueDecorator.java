 ...
 * @author lcy0x1
 */
public final class CardStringPermanentAddValueDecorator extends CardPermanentDecorator<
	...
	public CardStringPermanentAddValueDecorator(CardStringType type, String value) {
		this.type = type;
		this.value = value;
	}
